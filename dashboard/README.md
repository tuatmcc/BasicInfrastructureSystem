...
- `DISCORD_OAUTH_CLIENT_ID` / `DISCORD_OAUTH_CLIENT_SECRET` は Discord OAuth2 Application の `identify` 用設定
- `DISCORD_OAUTH_STATE_SECRET` は OAuth state 署名用の十分長いランダム文字列
